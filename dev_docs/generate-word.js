...
function buildSystemPrompt() {
  return "Ты помощник, который составляет карточки корейских слов для учебного приложения. " +
    ...
    '"kr": "слово на корейском (словарная форма). Если введённое слово написано с ошибкой, в неправильной ' +
    'форме или его вообще не существует, но по контексту понятно, какое слово имелось в виду — верни ' +
    'ИСПРАВЛЕННОЕ правильное слово в его словарной форме, а не то, что ввёл пользователь буквально", ' +
